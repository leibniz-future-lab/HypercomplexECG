"""
Adapted from: https://github.com/DeepPSP/torch_ecg/blob/master/torch_ecg/models/cnn/densenet.py
...
class DenseBasicBlock_PHC(nn.Module, SizeMixin):
    """
...
class DenseBottleNeck_PHC(nn.Module, SizeMixin):
    """
    ...
    def __init__(
        ...
        **config,
        ...
        self.neck_conv = PHConv_Bn_Activation(
            n = self.__n,
            in_channels=self.__in_channels,
        ...
        #     ordering="bac",
        # )
        self.main_conv = PHConv_Bn_Activation(
            n=self.__n,
...
class DenseMacroBlock_PHC(nn.Sequential, SizeMixin):
    """
    ...
    __DEBUG__ = True
    __name__ = "DenseMacroBlock_PHC"
    building_block = DenseBottleNeck_PHC
    ...
    def __init__(
        ...
        **config,
        ...
        if self.config.get("building_block", "").lower() in [
            ...
            self.building_block = DenseBasicBlock_PHC
...
class DenseTransition_PHC(nn.Sequential, SizeMixin):
    """
...
class DenseNet_PHC(nn.Sequential, SizeMixin):
    """
